...
@SpringBootApplication(scanBasePackages = CustomerApiApplication.BASE_PACKAGE)
@EnableSwagger2
public class CustomerApiApplication {
    ...
    static final String BASE_PACKAGE = "com.customerapi";

    private static final String CONTROLLER_PACKAGE = "com.customerapi.controller";
